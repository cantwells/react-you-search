                ...
                <section className="search">
                    <form className="form">
                        <div className="united-search">
                            <input type="text" className="search search__result" placeholder="Что хотите посмотреть?" />
                    ...
                    <div className="result__clips-grid">
                        <div className="item">
                            <div className="item__screen">
                                <img src={video} alt="video-screen"/>
                            </div>
                            <div className="item__title">
                                Как кормить кошку натуралкой | Перечень полезных для кош...
                            </div>
                            <div className="item__descr">
                                Ветеринария и Кормление соб...<br />786 тыс. просмотров
                            </div>
                        </div>
                    </div>
                </section>
