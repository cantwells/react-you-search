                            ...
                            <form className="form" onSubmit={handleSubmit}>
                                <div className="united-search">
                                    <input type="text" 
                                        ...
                                        />
                                    {/* <svg onClick={() => handleModalShow(true)} className="search__heart" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> */}
                                    <svg onClick={() => handleIsModalShow(true)} className={cn('search__heart', {'search__heart--fill': isFavourite()}) } viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
